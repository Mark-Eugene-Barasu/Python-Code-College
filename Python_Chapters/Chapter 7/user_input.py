...
unconfirmed_users = ['alice', 'brian', 'candace', 'jose', 'fuzzy', 'khetho']
confirmed_users = []
...
while 'rabbit' in pets:
    pets.remove('rabbit')  # Remove first occurrence of 'rabbit'

while 'dog' in pets:
    pets.remove('dog')  # Remove first occurrence of 'dog'
...
while polling_active:
    ...
    if repeat.lower().strip() == 'no':
        break  # End the poll if the user types 'no'
